(function()
{
 var Global=this,Runtime=this.IntelliFactory.Runtime,WebSharper,Arrays,Operators,Number,Array,Seq,Unchecked,Enumerator,Char,Util,Concurrency,setTimeout,Date,Scheduler,T,Json,JavaScript,List,T1,Error,Math,Remoting,XhrProvider,JSON,Enumerable,Strings,String,RegExp,Pervasives;
