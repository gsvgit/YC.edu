(function()
{
 var Global=this,Runtime=this.IntelliFactory.Runtime,WebSharper,Pervasives,List,Unchecked,Arrays,Control,Disposable,FSharpEvent,Util,Event,Event1,EventModule,HotStream,HotStream1,Observable,Observer,Operators,Observable1,T,ObservableModule,Observer1;
